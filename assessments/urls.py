...
from .views import (
    ...
    AssessmentSurvey2NextQuestionAPIView,
...
urlpatterns = [
    ...
    path('<uuid:pk>/survey2/next-question/', AssessmentSurvey2NextQuestionAPIView.as_view(), name='assessment-survey2-next-question'),
